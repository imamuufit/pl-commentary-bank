# HPA Event Watch Report — 2026-07-03 00:00 JST
...
Source: HPA top page year navigation.

| Year | Official navigation target | Status |
|---:|---|---|
...
| 2018 | `https://h-power.sakura.ne.jp/2018.pdf` | linked from HPA top; fetch returned transient/cache error in this run |
...
| 2015 | `https://h-power.sakura.ne.jp/2015.pdf` | linked from HPA top; fetch returned transient/cache error in this run |
...
- HPA top still lists the 2026 Numata Bench Press block with 速報 links and event materials, but no independent final `大会結果` PDF link was resolved.
- HPA official YouTube streams list includes the 2026 Numata Bench Press LIVE and 2026 Spring Powerlifting LIVE streams.
- The official 2026 schedule PDF and the 令和8年度事業計画書 both confirm the same 2026 major HPA event sequence: Ebetsu April, Numata June, Asahikawa October, Toyako November.
- 2018 and 2015 annual result URLs are linked from the HPA top page but returned transient/cache fetch errors in this run; keep them as linked-but-not-parsed until a later fetch succeeds.
